...
let MarketingPageModel = db.define('m_market_pages', {
  id: {
  ...
  mk_config: Sequelize.TEXT,
  mk_name: Sequelize.CHAR(255),
  mk_type: Sequelize.CHAR(255),
  create_time: {
    type: Sequelize.DATE,
    get() {
...
module.exports = MarketingPageModel