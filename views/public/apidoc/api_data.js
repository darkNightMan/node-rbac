define({ "api": [
        ...
        "Header": [
          {
            ...
            "optional": false,
            "field": "token",
            "defaultValue": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySW5mbyI6eyJjcmVhdG",
            "description": ""
          }
        ]
      }
  ...
  {
    "type": "post",
    "url": "/api/single/uploadImage/",
    "title": "上传图片",
    "description": "<p>上传单张图片</p>",
    "name": "upload",
    "group": "upload",
    "header": {
      "fields": {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:10086/api/single/uploadImage/"
      }
    ],
    "version": "1.0.0",
    "filename": "router/api/uploadimage.js",
    "groupTitle": "upload"
  }
] });
