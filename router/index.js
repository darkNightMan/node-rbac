...
module.exports = function (app) {
  ...
  app.get('/api/role/list', SysRoleController.list) // 获取所有的角色 
  app.post('/api/role/createRole', SysRoleController.createRole) // 新建角色 
  app.put('/api/role/updateRole', SysRoleController.updateRole) // 更新角色  
  app.delete('/api/role/deleteRole', SysRoleController.deleteRole)  // 删除角色 
  ...
  app.delete('/api/menu/deleteMenu', SysMenuController.deleteMenu) // 更新菜单  
